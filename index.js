...
const userIterface = document.getElementById("user-interface");
const handleResize = () => {
  userIterface.style.width = canvas.getBoundingClientRect().width + "px";
  userIterface.style.height = canvas.getBoundingClientRect().height + "px";
};
